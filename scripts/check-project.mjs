...
if (
  ...
  || !/stageResizeEnd\(event\)[\s\S]{0,1200}STAGE_RESIZE_DOUBLE_TAP_DELAY[\s\S]{0,180}closeStageResizeTapMenu\(\(\) => this\.toggleStageFit\(\)\)/.test(previewLogic)
  ...
  || ![previewStyle, embeddedPreviewStyle].every((style) => /stage-resizer__mode\s*\{[\s\S]{0,80}pointer-events:\s*auto/.test(style))
